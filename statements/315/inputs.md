# Erdős Problem 315 — drafting inputs
...
<title>315 | Erdős Problems</title>
<meta property="og:title" content="315 | Erdős Problems">
...
<div class="container">
  ...
  An earlier interpretation of this question on this site defined $u_1=2$ and $u_{n+1}=u_n^2-u_n+1$ (<a href="https://en.wikipedia.org/wiki/Sylvester%27s_sequence" rel="nofollow noopener noreferrer ugc" target="_blank">Sylvester's sequence</a>), which is the same sequence shifted by $1$; we use the phrasing above as more faithful to \cite{ErGr80}.<br><br>The constant $c_0$ is called the Vardi constant.<br><br>This is true, and was proved independently by Kamio \cite{Ka25} and Li and Tang \cite{LiTa25}.
  ...
  [Ka25] Y. Kamio, <i>Asymptotic analysis of infinite decompositions of a unit fraction into unit fractions</i>. arXiv:2503.02317 (2025).
  
  [LiTa25] Z. Li and Q. Tang, <i>On a conjecture of Erd\H{o}s and Graham about the Sylvester's sequence</i>. arXiv:2503.12277 (2025).
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/315">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos315.lean)
...
theorem main_theorem_no_shift_n_ge_2 (n : ℕ) (hn : 2 ≤ n) (a : ℕ → ℕ)
  ...
  (h_sum : ∑' i, (1 : ℝ) / a i = 1 / n)
  (h_neq : a 0 ≠ n + 1) :
  Filter.liminf (fun i => (a i : ℝ) ^ ((1 / 2 : ℝ) ^ (i + 1))) Filter.atTop < c n
```
...
theorem erdos_315 (a : ℕ → ℕ)
  ...
  Filter.liminf (fun i => (a i : ℝ) ^ ((1 / 2 : ℝ) ^ (i + 1))) Filter.atTop < vardi_constant
```

## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/315/Erdos315.lean)
