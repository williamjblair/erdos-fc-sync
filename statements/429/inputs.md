# Erdős Problem 429 — drafting inputs
...
<title>429 | Erdős Problems</title>
<meta property="og:title" content="429 | Erdős Problems">
...
<div class="container">
  ...
  Weisenberg \cite{We24} has shown the answer is no: $A$ can be arbitrarily sparse and missing at least one residue class modulo every prime $p$, and yet $A+n$ is not contained in the primes for any $n\in \mathbb{Z}$. (Weisenberg gives several constructions of such an $A$.)<br><br>In \cite{Er80} Erd\H{o}s further asks whether if $A$ does not cover all residue classes modulo $p^2$ for any prime $p$ then there are infinitely many $n$ such that all of $n+a_k$ are squarefree; a variant of Weisenberg's construction also shows the answer is no.
  ...
  [Er80] Erd\H{o}s, Paul, <i>A survey of problems in combinatorial number theory</i>. Ann. Discrete Math. (1980), 89-115.
  
  [We24] D. Weisenberg, <i>Sparse Admissible Sets and a Problem of Erd\H{o}s and Graham</i>. Integers (2024).
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/429">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos429.lean)
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/429/Erdos429.lean)
