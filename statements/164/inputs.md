# Erdős Problem 164 — drafting inputs
...
<title>164 | Erdős Problems</title>
<meta property="og:title" content="164 | Erdős Problems">
...
<div class="container">
  ...
  Erd\H{o}s \cite{Er35} proved that this sum always converges for a primitive set. Lichtman \cite{Li23} proved that the answer is yes. An alternative, simpler, proof is given by Alexeev, Barreto, Li, Lichtman, Price, Shah, Tang, and Tao \cite{ABLLPSTT26}. <br><br>See also <a href="/1196" rel="nofollow noopener noreferrer ugc" target="_blank">[1196]</a>.
  ...
  [ABLLPSTT26] B. Alexeev, K. Barreto, Y. Li, J. D. Lichtman, L. Price, J. I. Shah, Q. Tang, and T. Tao, <i>Primitive sets and Von Mangoldt Chains: Erd\H{o}s problem #1196 and beyond</i>. arXiv:2605.00301 (2026).
  
  [Er35] Erd\H{o}s, Paul, <i>Note on Sequences of Integers No One of Which is Divisible By Any Other</i>. J. London Math. Soc. (1935), 126-128.
  
  [Li23] Lichtman, J. D., <i>A proof of the Erd\H{o}s primitive set conjecture</i>. arXiv:2202.02384 (2023).
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/164">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos164.lean)

```lean
theorem erdos164 :
    PrimitiveSet primeSet ∧
      primitiveWeightSum primeSet = primeWeightSum ∧
      ∀ A : Set ℕ, PrimitiveSet A → primitiveWeightSum A ≤ primitiveWeightSum primeSet
```
...
## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/164/Erdos164.lean)
