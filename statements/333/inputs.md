# Erdős Problem 333 — drafting inputs
...
<title>333 | Erdős Problems</title>
<meta property="og:title" content="333 | Erdős Problems">
...
<div class="container">
  ...
  Erd\H{o}s and Newman \cite{ErNe77} have proved this is true when $A$ is the set of squares. In fact, Theorem 2 of \cite{ErNe77} already implies a negative answer to this problem, but this seems to have been overlooked by Erd\H{o}s and Graham.<br><br>See also <a href="/806" rel="nofollow noopener noreferrer ugc" target="_blank">[806]</a>.
  ...
  [ErNe77] Erd\H{o}s, P. and Newman, D. J., <i>Bases for sets of integers</i>. J. Number Theory (1977), 420-425.
  
  </div>
                                        
  <div class="problem-additional-text" style="text-align:center; padding: 10px;">
  <a href="/333">Back to the problem</a>
  </div>
...
## Hosted theorem — plby (https://github.com/plby/lean-proofs/blob/main/src/v4.29.1/ErdosProblems/Erdos333.lean)
...
theorem exists_hitting_set_log_bound
    ...
    ∃ H : Finset ℕ, H ⊆ U ∧ (∀ F ∈ 𝓕, (H ∩ F).Nonempty) ∧
      (H.card : ℝ) ≤ Real.log 𝓕.card / Real.log (1 / (1 - δ)) + 1
```
...
theorem exists_hard_set (N : ℕ) (hN : 8 ≤ N) (hN_even : Even N) :
    ∃ A_N : Finset ℕ, A_N ⊆ J N ∧
      ...
      ((A_N.card : ℝ) ≤ Real.log (𝓒 N).card / Real.log (1 / (1 - delta)) + 1)
```

## Hosted theorem — jayyhk (https://github.com/Jayyhk/erdos-lean/blob/main/problems/333/Erdos333.lean)
