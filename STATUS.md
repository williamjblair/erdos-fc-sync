...
|---|---:|---|
| `statement` | 73 | **Write the FC statement + link.** A complete hosted proof exists, FC has no file yet. The #3998 batch. |
...
| `in-pr` | 49 | **Claimed.** An open FC pull request (or a tracked issue claim) already covers this. |
